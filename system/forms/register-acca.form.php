...
<div class="studentdetails formElement" style=" margin-bottom: 20px;">
	...
	<tr>
		<td><strong><?php $countsub++; echo $count .'.'. $countsub . ' - '; ?> ACCA Registration Number</strong></td>
		<td>
			<input type="text" name="acca" id="acca" />
		</td>	
		<td>
			<div id="status">
			Please enter the ACCA registration number
			</div>
		</td>
	</tr>
...
<div id="programheader" class="studentname">2 - Select your ACCA papers</div>
...
<div class="programdetails formElement" style="display: none; padding-left: 30px;  margin-bottom: 20px;">
	<p><b>Select up to three papers. </p>

	<table>
	<tr>
		<td><strong>Paper one</strong></td>
		<td>
	...
	<tr>
		<td><strong>Paper three</strong></td>
		<td>
			
			<select name="paper3" id="paper3">
				<option value="none" selected="selected">no selection</option>
				<?php echo $courses;  ?>
			</select>
		</td>
...
if($this->core->cleanGet['existing'] == "yes"){
	echo'<div id="submitheader" class="studentname">3 - Submit updated information</div>';
}else{
	echo'<div id="submitheader" class="studentname">3 - Submit your application</div>';
}
?>
...
$( "#submitheader" ).click(function() {
	...
	if(input.type == "submit"){
        ...
        if(input.type == "text" && input.value == "" || input.type == "email" && input.value == "") {
		not_pass = true;
...
$_SESSION['math'] = $one + $two;

?>

<div class="submitdetails formElement" style="display: none; padding-left: 30px;  margin-bottom: 20px;">
	<p><b>Solve the math problem and click on the button to submit the form. </p>

	<table>
	<tr>
		<td><strong>How much is <?php echo $one; ?> plus <?php echo $two; ?></strong></td>
		<td>
			<input type="number" name="math" style="width: 80px"/></td>
		<td>Enter Number</td>
	</tr>
	</table>
