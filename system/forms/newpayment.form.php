<div class="heading"><?php echo $this->core->translate("Create Payment Voucher "); ?></div>
...
<option value="Workshops/Venues">Workshops/Venues</option>
	...
	<div class="label"><?php echo $this->core->translate("Payment method"); ?>:</div> 
		<select name="method" style="width: 260px"> 
	...
	<table class="table">
		<tr style="font-weight: bold"><td>#</td><td>Item Name</td><td>Item Specifications</td><td>Quantity</td><td>Unit Cost</td><td>Pay</td></tr>
	...
	<input type="submit" name="submit" value="Create Payment Voucher" id="submit" class="submit" style="width: 260px"/>
</form>
