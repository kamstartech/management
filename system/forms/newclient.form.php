<h1>Add Client</h1>
<p>Use the form below to define a new client.</p>
<form id="addclient" name="addclient" method="POST" action = "<?php echo $this->core->conf['conf']['path'] . "/clients/save/". $this->core->item; ?>" >

<div class="table-responsive">
<table class="table">
	<tr>
		<td style="width: 200px;">Client Name:</td>
		<td><input type="text" id="name" name="name" value="<?php echo $name; ?>" required> <i>Client Name.</i></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="number" id="pacra" name="pacra" value="<?php echo $brn; ?>" > <i>PACRA number</i></td>
	</tr>

	<tr>
		<td style="width: 200px;" >Client Categories:</td>
		<td><select name="category" style="width: 250px; margin-right: -10px;" class="select" required> 
			...
			</select> <i>Category of client.</i></td>
	</tr>
</table>

	
	<div class="label"></div><input type="submit" name="submit" value="Create Client" id="submit" class="submit" style="width: 100%; padding: 20px !important;"/>
</form>
</div>
