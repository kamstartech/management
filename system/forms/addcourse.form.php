...
<form id="addcourse" name="addcourse" method="post" action="<?php echo $this->core->conf['conf']['path'] . "/courses/save"; ?>">
	...
	<table width="768" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="name" pattern="[a-zA-Z0-9]*" required></td>
                <td><b>NO SPACES, DASHES OR OTHER CHARACTERS IN THE COURSE CODE</b></td>
              </tr>
			...
			<?php echo $distance; ?>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="credits" style="width: 60px;" required> <b> Credits</b>
		</td>
                <td></td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="examweight" style="width: 60px;" required> <b>%</b>
		</td>
                <td></td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="assessmentweight" style="width: 60px;" required> <b>%</b>
		</td>
                <td></td>
              </tr>
