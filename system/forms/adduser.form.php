...
<tr>
	...
	<td>
		<input type="text" name="email" id="textfield87" required></td>
...
<tr>
	...
	<tr >
		...
		<td>
			<input type="text" name="empno" id="empno"></td>
		<td>The employee number (leave blank for auto numbering)</td>
	</tr>
	<tr >
		<td height="19"><strong>Job Title</strong></td>
		<td>
	...
	<tr >
		<td height="19"><strong>Social Security Number</strong></td>
		<td>
			<input type="text" name="ssn" id="ssn"></td>
		<td>The social security number</td>
	</tr>
	<tr >
		<td height="19"><strong>Employment date</strong></td>
		<td>
			<input type="text" name="empstart" id="empstart"></td>
		<td>First day at work</td>
	</tr>
	<tr >
		<td height="19"><strong>End of Employment date</strong></td>
		<td>
			<input type="text" name="empend" id="empend"></td>
		<td>End date on contract</td>
	</tr>
	<tr >
		<td height="19"><strong>Basic Pay</strong></td>
		<td>
			<input type="text" name="basicpay" id="basicpay"></td>
		<td>Basic Pay</td>
	</tr>
</table>
</td>
