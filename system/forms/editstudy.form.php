...
<form id="addstudy" name="addstudy" method="post" action="<?php echo $this->core->conf['conf']['path'] . "/studies/save/" . $this->core->item; ?>">
	...
	<tr><td>Program Coordinator</td>
	<td>
		<select name="coordinator" id="coordinator" class="">
			<?php echo $users; ?>
        </select>
	</td>
	<td></td>
