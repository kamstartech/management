...
<div class="studentdetails formElement" style=" margin-bottom: 20px;">
		...
		<td>
			<?php
				if($existing=="yes"){
					...
					echo'<input class="form-control" type="text" name="studentid" id="nrc"/>';
				}
			?>
		</td>
		<td>
	...
	<tr>
		...
		<td>
			<div style="float:left;"><select class="form-control" name="day" id="day">
