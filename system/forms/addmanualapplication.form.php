<!-- <div class="col-md-6">
            <div class="card card-success">
              ...
              <form role="form" id="enroll" name="enroll" method="post" action="https://edurole.mu.ac.zm/register/submit" enctype="multipart/form-data">
                <div class="card-body">
...
<div class="studentdetails formElement">
		...
		<td>
			<?php
				if($existing=="yes"){
					...
					echo'<input type="text" name="studentid" id="nrc" required/>';
				}
			?>
		</td>
		<td>
	...
	<tr>
		...
		<td>
			<input type="file" name="nrcupload" id="nrcupload" data-pattern-name="education[++][upload]" data-pattern-id="education_++_upload" required/></td>
	...
	<tr>
		<td><strong> Study Delivery Mode</strong></td>
		<td>
...
?>
	<tr>
		<td><strong>  Student Lodging?</strong></td>
		<td>
	...
	<input type="submit" class="register" name="submit-registrar" id="submit-registrar" value="SAVE INFORMATION"/>
</div>
...
if($this->core->cleanGet['existing'] != "yes"){
	...
	<div class="results formElement"  margin-bottom: 20px;">
	...
	<p>
		...
		<input type="file" name="grade12" id="grade12" data-pattern-name="education[++][upload]" data-pattern-id="education_++_upload"/>
	</p>
...
echo'<div class="educationalrecords formElement">
...
<div id="emergencyheader" class="studentname"><?php $count++; echo $count; ?> - Sponsor Information</div>
...
<script>
	...
	<div class="emergencycontact" id="sponsor" >
...
<div class="programdetails formElement">
	...
	<table width="768" height="94" border="0" cellpadding="5" cellspacing="0">
		...
		<tr>
			<td height="22"><b> Third choice:</b><br></td>
			<td>
...
<div class="submitdetails formElement">
	<p><b>Click on the button to submit the form. </p>
