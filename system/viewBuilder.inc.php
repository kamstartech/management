...
class viewBuilder {
        ...
        public function buildView($page, $external = FALSE) {
                ...
                } elseif ($page == "login" &&  $this->core->cleanPost['username'] != '') {
                ...
                //if(method_exists($this->core, $function)){
        ...
        public function processView($function, $settings = NULL) {
                ...
                if ($this->viewConfig->breadcrumb == TRUE && $this->core->template != 'desktop') {
                ...
                if ($this->viewConfig->description == TRUE && $this->core->template != 'desktop') {
                ...
                if ($this->viewConfig->footer == TRUE) {
                        ...
                        if($this->core->role >= 100 && $this->core->template != 'mobile' && $this->core->template != 'desktop'){
